...
namespace MasterDetailApp
{
    ...
    public ref class NewFuellingPage sealed
    {
    public:
        /*++
        Routine Description:
    ...
    private:
        ...
        --*/
        void NewFuelingPage_BackRequested(Platform::Object ^sender, Windows::UI::Core::BackRequestedEventArgs ^args);
        ...
        --*/
        FuelingInfo^ PopulateFuelingInfoObject();
