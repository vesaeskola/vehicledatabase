...
This module declare NewServicePage class. NewServicePage implement user interface to enter and edit service of vehicle.
...
namespace MasterDetailApp
{
    ...
    public ref class NewServicePage sealed
    {
    public:
        /*++
        Routine Description:
    ...
    private:
        ...
        --*/
        void NewServicePage_BackRequested(Platform::Object ^sender, Windows::UI::Core::BackRequestedEventArgs ^args);
        ...
        Return Value: EventInfo^. ServiceInfo object.
